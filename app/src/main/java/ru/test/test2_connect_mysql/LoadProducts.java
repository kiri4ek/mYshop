...
{
    public Integer id;
    public ReloadGlobalProduct rGP;
    public View view;
    private ProgressDialog dialog;
    private Context context;

    public LoadProducts(Integer id, ReloadGlobalProduct rgp, View view, Context context)
    {
        this.id = id;
        this.rGP = rgp;
        this.view = view;
    ...
    protected void onPostExecute(String result) {
        //this.dialog.dismiss();
        this.rGP.out(Html.fromHtml(result).toString(), view, id);
