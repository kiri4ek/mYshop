...
public class Sets extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Наборы");
        ...
        new KolProductChanceSets(type, chance1, chance2, this).execute();
    ...
    public void ReloadProduct()
    {
        ...
        if (!id.equals(""))
        {
            ...
            for (int i = 0; i < s_id.length; i++)
            {
                ...
                glob.ReloadGlobalProduct(linear, view, s_id[i], Color.rgb(100,34,25), Color.rgb(66,33,100), this);
            }
        }
    }
