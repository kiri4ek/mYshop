...
public class KolProductChanceMenu extends AsyncTask<String, Void, String>
{
    ...
    public KolProductChanceMenu(String type, Double chance1, Double chance2, Menu m)
    {
    ...
    protected void onPreExecute() {
        this.dialog = new ProgressDialog(this.M);
    ...
    protected void onPostExecute(String result) {
        dialog.dismiss();
        this.M.out(Html.fromHtml(result).toString());
    }
}
