...
public class KolProductChanceDiscounts extends AsyncTask<String, Void, String>
{
    ...
    public KolProductChanceDiscounts(String type, Double chance1, Double chance2, Discounts d)
    {
    ...
    protected void onPostExecute(String result) {
        dialog.dismiss();
        this.D.out(Html.fromHtml(result).toString());
    }
}
