...
public class Menu extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Double chance1 = 0.5, chance2 = 1.0;
        //String type = "Стандарт";

        new KolProductAllMenu(this).execute();
    ...
    public void ReloadProduct()
    {
        ...
        if (!id.equals(""))
        {
            ...
            for (int i = 0; i < s_id.length; i++)
            {
                ...
                glob.ReloadGlobalProduct(linear, view, s_id[i], Color.rgb(100,34,25), Color.rgb(224,224,224), this);
            }
        }
    }
